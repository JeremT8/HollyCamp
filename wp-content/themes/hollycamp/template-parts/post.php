<article class="news">
	<a href="<?php the_permalink() ?>" title="<?= esc_attr(get_the_title()) ?>" class="news__image">
		...
		<?php else : ?>
			<img width="250" height="250" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNcv35DPQAGsgKPMRXUiQAAAABJRU5ErkJggg==">
		<?php endif; ?>
	</a>
	<div class="news__body">
		<header class="news__header">
			...
			<div class="news__date"><?= sprintf(__('Published on %s at %s', 'hollycamp'), get_the_date(), get_the_time()) ?></div>
		</header>
